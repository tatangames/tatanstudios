            ...
            <div class="modal-dialog">
                <div class="modal-content">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                            <label>Duracíon Días de Membresia <span style="color: red">*</span></label>
                                            <input type="number" class="form-control" id="duracion-nuevo" placeholder="Duración">
                                        </div>

                                        <div class="form-group">
                                            <label>Descripción</label>
                                            <input type="text" maxlength="1000" class="form-control" id="descripcion-nuevo" placeholder="Descripción">
                                        </div>
                    ...
                    <div class="modal-footer justify-content-between">
                        ...
                        <button type="button" class="btn btn-success btn-sm" onclick="nuevo()">Agregar</button>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                            <label>Duracíon Días de Membresia <span style="color: red">*</span></label>
                                            <input type="number" class="form-control" id="duracion-editar" placeholder="Duración">
                                        </div>

                                        <div class="form-group">
                                            <label>Descripción</label>
                                            <input type="text" maxlength="1000" class="form-control" id="descripcion-editar" placeholder="Descripción">
                                        </div>
...
@section('js')
    ...
    <script src="{{ asset('js/alertaPersonalizada.js') }}"></script>
        ...
        <script>
            $(function () {
                const ruta = "{{ url('/admin/membresias/tabla') }}";
    ...
    <script>
        ...
        function nuevo(){
            ...
            var duracion = document.getElementById('duracion-nuevo').value;
            ...
            if(duracion === ''){
                toastr.error('Duración es requerido');
                return;
            }

            if(!duracion.match(reglaNumeroEntero)) {
                toastr.error('Duración debe ser número Entero');
                return;
            }

            if(duracion < 0){
                toastr.error('Duración no debe ser negativo');
                return;
            }

            if(duracion > 5000){
                toastr.error('Duración debe ser máximo 5000');
                return;
            }
            ...
            axios.post('/admin/membresias/nuevo', formData, {
            })
                .then((response) => {
                    closeLoading();
        ...
        function verInformacion(id){
            ...
            axios.post('/admin/membresias/informacion',{
                'id': id
            })
                .then((response) => {
                    closeLoading();
                    if(response.data.success === 1){
                        ...
                        $('#duracion-editar').val(response.data.info.duracion_dias);
        ...
        function editar(){
            ...
            var duracion = document.getElementById('duracion-editar').value;
            ...
            axios.post('/admin/membresias/editar', formData, {
            })
                .then((response) => {
                    closeLoading();
