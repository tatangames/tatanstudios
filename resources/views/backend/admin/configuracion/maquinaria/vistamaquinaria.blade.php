...
@section('content')
    ...
    <div id="divcontenedor">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group mb-3" style="max-width: 100%">
                                            <label class="mb-1">Categoría <span style="color: red">*</span></label>
                                            <select class="form-control form-control-sm" id="select-categoria-nuevo">
                                        ...
                                        <div class="form-group">
                                            <label>Costo</label>
                                            <input type="number" min="0" value="0" class="form-control" id="precio-nuevo" placeholder="Precio">
                                        </div>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group mb-3" style="max-width: 100%">
                                            <label class="mb-1">Categoría <span style="color: red">*</span></label>
                                            <select class="form-control form-control-sm" id="select-categoria-editar">
                                            </select>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <label>Costo</label>
                                            <input type="number" min="0" value="0" class="form-control" id="precio-editar" placeholder="Precio">
                                        </div>
        ...
        @section('js')
            ...
            <script>
                $(function () {
                    const ruta = "{{ url('/admin/maquinaria/tabla') }}";
    ...
    <script>
        ...
        function nuevo(){
            var categoria = document.getElementById('select-categoria-nuevo').value;
            ...
            axios.post('/admin/maquinaria/nuevo', formData, {
            })
                .then((response) => {
                    closeLoading();
        ...
        function verInformacion(id){
            ...
            axios.post('/admin/maquinaria/informacion',{
                'id': id
            })
                .then((response) => {
                    closeLoading();
                    if(response.data.success === 1){
                        ...
                        $.each(response.data.categoria, function( key, val ){
                            if(response.data.info.id_maqui_categoria == val.id){
        ...
        function editar(){
            ...
            var categoria = document.getElementById('select-categoria-editar').value;
            ...
            axios.post('/admin/maquinaria/editar', formData, {
            })
                .then((response) => {
                    closeLoading();
        ...
        function modalBorrar(id){
            Swal.fire({
                title: '¿Borrar?',
                text: "Esto eliminara hasta sus mantenimientos registrados",
        ...
        function borrarFila(id){
            ...
            axios.post('/admin/maquinaria/borrar', formData, {
            })
                .then((response) => {
                    closeLoading();
        ...
        function vistaMantenimientos(id){
            window.location.href="{{ url('/admin/historial/mantenimiento/index') }}/" + id;
        }
