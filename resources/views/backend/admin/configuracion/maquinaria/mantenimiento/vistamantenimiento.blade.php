...
@section('title', 'Historial Mantenimiento')
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" min="0" class="form-control" id="precio-nuevo" placeholder="Precio">
                                        </div>
        ...
        @section('js')
            ...
            <script>
                $(function () {
                    ...
                    const ruta = "{{ url('/admin/historial/mantenimiento/tabla') }}/" + idequipo;
            ...
            <script>
                ...
                function nuevo(){
                    ...
                    formData.append('idmaquinaria', idequipo);
                    formData.append('fecha', fecha);
                    formData.append('precio', precio);
                    formData.append('descripcion', descripcion);

                    axios.post('/admin/historial/mantenimiento/nuevo', formData, {
                    })
                        .then((response) => {
                            closeLoading();
                ...
                function borrarFila(id){
                    ...
                    axios.post('/admin/historial/mantenimiento/borrar', formData, {
                    })
                        .then((response) => {
                            closeLoading();
