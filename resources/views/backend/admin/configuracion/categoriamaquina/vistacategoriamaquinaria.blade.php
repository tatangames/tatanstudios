...
@section('js')
    ...
    <script src="{{ asset('js/alertaPersonalizada.js') }}"></script>
        ...
        <script>
            $(function () {
                const ruta = "{{ url('/admin/categorias/maquinaria/tabla') }}";
    ...
    <script>
        ...
        function nuevo(){
            ...
            axios.post('/admin/categorias/maquinaria/nuevo', formData, {
            })
                .then((response) => {
                    closeLoading();
        ...
        function verInformacion(id){
            ...
            axios.post('/admin/categorias/maquinaria/informacion',{
                'id': id
            })
                .then((response) => {
                    closeLoading();
        ...
        function editar(){
            ...
            axios.post('/admin/categorias/maquinaria/editar', formData, {
            })
                .then((response) => {
                    closeLoading();
